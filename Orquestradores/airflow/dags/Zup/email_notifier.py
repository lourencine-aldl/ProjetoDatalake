# -*- coding: utf-8 -*-
"""
Notificador de email customizado para callbacks das DAGs ZUQ
...
def notify_success(context):
    ...
    <body style="font-family: Arial, sans-serif;">
        ...
        <p style="background: #d4edda; padding: 15px; border-left: 4px solid #28a745;">
            <strong>APIs ZUQ extraídas com sucesso!</strong><br>
            Dados (vehicle_daily e driver_workjourney) foram processados e salvos em Parquet no MinIO.
        </p>
    </body>
    </html>
    """
...
def notify_failure(context):
    ...
    <body style="font-family: Arial, sans-serif;">
        ...
        <div style="background: #f8d7da; padding: 15px; border-left: 4px solid #dc3545;">
            <strong>Erro na extração das APIs ZUQ:</strong><br>
